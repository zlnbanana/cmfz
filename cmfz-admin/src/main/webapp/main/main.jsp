...
<head>
    ...
    <script type="text/javascript">
	    ...
	    $(function(){
	        $.ajax({
                url:"${pageContext.request.contextPath}/menu/showAllMenu", // isELIgnored  表示不忽略页面的el表达式
                dataType:"json",
                success:function(res){
                    //console.log(res);
                    // 遍历响应集合
                    // 参数res： 代表的当前遍历的集合  index：当前遍历的下标  obj:   遍历过程中的临时变量
...
<body class="easyui-layout">
    <div data-options="region:'north',split:true" style="height:60px;background-color:  #5C160C">
        ...
        <div style="font-size: 16px;color: #FAF7F7;font-family: 楷体;width: 300px;float:right;padding-top:15px">欢迎您:${manager.mgrName}
    ...
    <div data-options="region:'south',split:true" style="height: 30px;background: #5C160C">
